...
(function() {
    ...
    var colorMove = {
        ...
        applyDragEvents: function(element2) {
            ...
            element2.addEventListener('dragstart', function(e) {
        ...
        applyDropEvents: function(dropper2) {
            ...
            dropper2.addEventListener('dragover', function(e) {
                e.preventDefault();
                this.className = 'dropper2 drop_hover2';
            });
    ...
    var elements2 = document.querySelectorAll('.draggable2'),
        elements2Len = elements2.length;
    
    for (var i = 0; i < elements2Len; i++) {
        colorMove.applyDragEvents(elements2[i]);
    }

    var droppers2 = document.querySelectorAll('.dropper2'),
        droppers2Len = droppers2.length;
    
    for (var i = 0; i < droppers2Len; i++) {
        colorMove.applyDropEvents(droppers2[i]);
    }
