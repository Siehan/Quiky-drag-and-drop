...
(function () {
    ...
    var dndHandler = {
        ...
        applyDropEvents: function (dropper) {
            ...
            dropper.addEventListener('dragover', function (e) {
                e.preventDefault();
                this.className = 'caseTableau1';
            });

            dropper.addEventListener('dragleave', function () {
                this.className = 'caseTableau2';
            });
    ...
    var elements = document.querySelectorAll('.caseTableau1'),
    ...
    var droppers = document.querySelectorAll('.caseTableau2'),
