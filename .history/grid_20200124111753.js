...
function goodCase(dropper.this) {

    if(div.draggable.case0.caseTableau1 !== div.dropper.case0.caseTableau2)
    console.log("Boooh Game Over!")
}
...
function timer() {
    hourglass("time", 55, 0, "The game ends in ", " seconds", function () {
        alert("Game over !");
    });
};
