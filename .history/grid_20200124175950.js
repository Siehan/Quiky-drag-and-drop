    ...
    var dndHandler = {
        ...
        applyDropEvents: function (dropper) {
            dropper.addEventListener("dragover", function (e) {
                e.preventDefault();
                if (!this.className.includes("drop_hover")) {
                    this.className = this.className + " drop_hover"
                }
            ...
            dropper.addEventListener("drop", function (e) {
                ...
                const caseee = target.className.split(" ")[1]
                const dropCase = dndHandler.draggedElement.className.split(" ")
